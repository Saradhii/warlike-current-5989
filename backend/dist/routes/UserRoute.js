...
UserRoute.get("/profile/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const Signleuser = yield User.find(req.params);
    if (!token) {
...
UserRoute.post("/newtoken", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = req.headers.authentication;
    // console.log(token);
    const user = yield User.find(req.params);
    if (!token) {
        return res.send("forbiden");
    }
    try {
        ...
        // console.log("Decode",decoded);
        if (decoded) {
            const accessToken = jwt.sign({ first_name: user === null || user === void 0 ? void 0 : user.first_name, last_name: user === null || user === void 0 ? void 0 : user.last_name, id: user === null || user === void 0 ? void 0 : user._id }, 'SECRET1234', { expiresIn: "15min" });
