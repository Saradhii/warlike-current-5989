    ...
    <div className={styles.payment_main}>
      <div className={styles.payment_data}>
        ...
        <div className={styles.payment_userdetails}>
          ...
          <h5>Ship to :</h5>
          <hr></hr>
          <h5>Method: Free Standard Shipping ( Debit Card / Credit Card / Net Banking / PayTM ) · Free</h5>
        </div>
...
          <label htmlFor="html">Credit Card / Debit Card / Net Banking / UPI</label> </div>
        </AccordionSummary>
        <AccordionDetails>
            <div className={styles.icondiv1}>
            <CreditCardIcon className={styles.icondiv}></CreditCardIcon><br></br>
            After clicking “Complete order”, you will be redirected to Credit Card / Debit Card / Net Banking / UPI to complete your purchase securely.
            </div>
        </AccordionDetails>
      </Accordion>
      <Accordion>
...
          <label htmlFor="html"><img src="https://cdn.shopify.com/shopifycloud/shopify/assets/checkout/offsite-gateway-logos/paytm@2x-af01977ff64627f57925062e195a194de280c6c879267a51456c0d579acb90c2.png"/></label>
          </div>
        </AccordionSummary>
        <AccordionDetails>
          <div>
...
          <label htmlFor="html">Use a different billing address</label>
        ...
        <AccordionDetails>
          ...
          <div className={styles.payment_inputs}>
           <input className={styles.inputbar} type="text" placeholder='Address'/><br></br>
           <input className={styles.inputbar} type="text" placeholder='City'/><br></br>
           <input className={styles.inputbar} type="text" placeholder='Phone'/><br></br>
          </div>
          </div>
        </AccordionDetails>
      </Accordion>
        ...
        <div className={styles.chout}>
             <p> Return to Cart page</p><br></br>
             <button>Complete Order</button>
        </div>
        <div className={styles.chout1}>
             <hr></hr>
             <p>Refund policy &nbsp;&nbsp;&nbsp;Privacy policy &nbsp;&nbsp;&nbsp;Terms of service</p>
        </div>
      ...
      <div className={styles.payment_items}>
        <div className={styles.payment_item1}>
          ...
          <div className={styles.couponcode}>
            <input className={styles.inputbar} type="text" placeholder='Discount code'/>&nbsp;&nbsp;
            <button>APPLY</button>
          </div>
